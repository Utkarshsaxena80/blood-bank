...
export default function DonorLoginPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    setErrors({})
    alert("Donor login successful (mock)!")
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-8 w-full max-w-md">
        <div className="flex items-center space-x-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Donor Login</h2>
        </div>
        ...
        <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">
          ...
          <Link href="/register/donor" className="text-red-600 hover:underline">Register</Link>
        </p>
      </div>
    </div>
  )
